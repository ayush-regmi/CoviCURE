...
#include <memory>
#include "../../CoviCURE/Headers/Rapidcovid/messagepage.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Messagepage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Messagepage_t qt_meta_stringdata_Messagepage = {
    {
QT_MOC_LITERAL(0, 11) // "Messagepage"
...
const QMetaObject Messagepage::staticMetaObject = { {
    ...
    qt_meta_stringdata_Messagepage.offsetsAndSize,
    qt_meta_data_Messagepage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Messagepage_t
, QtPrivate::TypeAndForceComplete<Messagepage, std::true_type>
