...
#include <memory>
#include "../../CoviCURE/Headers/Vaccine/loginview.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Loginview_t, stringdata0) + ofs), len 
...
const QMetaObject Loginview::staticMetaObject = { {
    ...
    qt_meta_stringdata_Loginview.offsetsAndSize,
